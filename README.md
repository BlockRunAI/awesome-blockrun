...
> **BlockRun** is the routing & payment layer for AI — one endpoint where AI agents autonomously discover, route, and pay for APIs using USDC via the x402 protocol. BlockRun provides pay-per-request access to <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> large language models (including GPT-5, Claude, Gemini, Grok, DeepSeek, and Kimi), image generation, neural web search (Exa), DEX data, trading signals, and prediction market data. Use one account API key or pay directly from a wallet with x402.
>
> **For Claude Code users:** Add BlockRun in one command — access <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models, DEX data, trading signals, and more with account API billing or a Solana wallet.
> ```bash
...
|---------|----------|---------|-------------|
| **LLM Chat** | `/v1/chat/completions` | Per token | OpenAI-compatible, <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models, streaming, tool calling |
...
**<!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models** across 11 providers — <!-- br:models.free -->6<!-- /br:models.free --> of them free and keyless. All accessible through a single OpenAI-compatible API.
...
| **Base** | `blockrun.ai` | USDC | ✅ Live (<!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> models) |
...
| Tool | What it does |
|------|-------------|
| `blockrun_chat` | <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> AI models (GPT-5.5, Claude, Gemini, Grok, DeepSeek, Kimi, and more) |
...
|-------|----------|-------|
| LLM Gateway | Now | Pay-per-request access to <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> AI models |
...
### What is BlockRun?
BlockRun is the routing & payment layer for AI — one endpoint where AI agents discover, route, and pay for APIs using USDC via the x402 protocol. It provides access to <!-- br:models.chatVisible -->77<!-- /br:models.chatVisible --> LLMs, image generation, neural web search (Exa), and prediction market data without requiring API keys or subscriptions.
