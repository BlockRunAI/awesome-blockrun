...
| [blockrun-mcp](https://github.com/BlockRunAI/blockrun-mcp) | MCP server for 30+ AI models | [GitHub](https://github.com/BlockRunAI/blockrun-mcp) |
...
|----------|------------|--------|
| Python | [blockrun-llm](https://github.com/blockrunai/blockrun-llm) | Stable |
| TypeScript | [blockrun-llm-ts](https://github.com/blockrunai/blockrun-llm-ts) | Stable |
| Go | [blockrun-llm-go](https://github.com/blockrunai/blockrun-llm-go) | Stable |
...
| AgentKit | Compatible | [Integration Guide](../frameworks/agentkit.md) |
