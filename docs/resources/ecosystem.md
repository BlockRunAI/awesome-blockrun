...
| [blockrun-mcp](https://github.com/BlockRunAI/blockrun-mcp) | MCP server for 55+ AI models, images, video, music, voice, prediction markets, crypto data, sandbox runtime, smart routing | [GitHub](https://github.com/BlockRunAI/blockrun-mcp) |
