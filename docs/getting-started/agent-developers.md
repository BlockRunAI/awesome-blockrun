...
description: Build AI agents that pay for their own intelligence — 77 models via x402 micropayments. Use Franklin, the SDKs or the MCP, or the framework you already use.
---
