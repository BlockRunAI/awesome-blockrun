...
description: Build AI agents that pay for their own intelligence — 55+ models via x402 micropayments. Use Franklin, the SDKs, or the MCP; integrate with frameworks if you already use one.
---
