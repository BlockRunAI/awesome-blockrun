...
description: Install BlockRun MCP in Claude Code, fund a wallet with USDC on Base or Solana, and give your agent 64 models, images, and live data.
---
...
Claude automatically routes to 84 AI models and pays via x402.
...
64 LLMs with live pricing, plus smart routing to cut costs automatically.
:::
