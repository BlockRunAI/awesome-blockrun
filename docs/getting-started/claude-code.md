...
description: Install BlockRun MCP in Claude Code, fund a wallet with USDC on Base or Solana, and give your agent 55+ models, images, and live data.
---
...
55+ LLMs with live pricing, plus smart routing to cut costs automatically.
:::
