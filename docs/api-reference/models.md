---
title: Models
description: List and price 55+ models across chat, image, video, music, and speech from one unified BlockRun API, with a flat 5% platform fee over provider rates.
---
