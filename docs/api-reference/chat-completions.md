...
description: OpenAI-compatible Chat Completions endpoint for 74 LLMs, paid per request in USDC over x402 — no API keys, no subscriptions.
---
...
74 chat models with live pricing — pick the right model and ID for your call.
:::
