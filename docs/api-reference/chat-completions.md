...
description: OpenAI-compatible Chat Completions endpoint for 55+ LLMs, paid per request in USDC over x402 — no API keys, no subscriptions.
---
...
55+ chat models with live pricing — pick the right model and ID for your call.
:::
