...
description: The official BlockRun TypeScript/JavaScript SDK — call 72 LLMs, smart routing, and prediction markets over x402 micropayments with no API keys.
---
...
Browse all 72 models with live pricing to pick the right one for each call.
:::
