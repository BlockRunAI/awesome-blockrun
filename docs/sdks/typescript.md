...
description: The official BlockRun TypeScript/JavaScript SDK — call 74 LLMs, smart routing, and prediction markets over x402 micropayments with no API keys.
---
