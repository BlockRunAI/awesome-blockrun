...
description: Add the BlockRun plugin to ElizaOS so your agents reach 99 AI models via x402 micropayments — no per-provider API keys.
---

# ElizaOS Integration

Use BlockRun as an LLM provider in ElizaOS agents — one plugin unlocks 75 models paid per request over x402.
...
[ElizaOS](https://github.com/elizaOS/eliza) is an open-source agent framework. The BlockRun plugin gives your ElizaOS agents access to 99 AI models via x402 micropayments.
