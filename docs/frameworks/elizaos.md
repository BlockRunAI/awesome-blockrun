...
description: Add the BlockRun plugin to ElizaOS so your agents reach 55+ AI models via x402 micropayments — no per-provider API keys.
---

# ElizaOS Integration

Use BlockRun as an LLM provider in ElizaOS agents — one plugin unlocks 55+ models paid per request over x402.
