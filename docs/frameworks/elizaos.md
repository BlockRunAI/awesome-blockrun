...
description: Add the BlockRun plugin to ElizaOS so your agents reach 80 AI models via x402 micropayments — no per-provider API keys.
---
...
[ElizaOS](https://github.com/elizaOS/eliza) is an open-source agent framework. The BlockRun plugin gives your ElizaOS agents access to 80 AI models via x402 micropayments.
