...
description: Pair Coinbase AgentKit with BlockRun so your agents both hold on-chain assets and pay per request for 98 AI models.
---
...
BlockRun adds:
- 74 chat models (95 in the full catalog)
