---
title: BlockRun MCP
description: A Model Context Protocol server that gives Claude Code 72 models, crypto data, voice calls, media generation, and prediction markets with zero API keys.
---
