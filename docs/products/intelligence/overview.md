---
title: Intelligence
description: BlockRun Intelligence gives your agent 74 LLMs through one OpenAI-compatible API, paid per request in USDC — no API keys, no subscriptions.
---

# Intelligence

AI accesses any LLM. 74 models, pay-per-request.
