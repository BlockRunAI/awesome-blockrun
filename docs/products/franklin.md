...
description: Franklin is the AI agent with a wallet — it writes code and spends USDC autonomously across 72 models and paid APIs, settling per outcome over x402. No subscriptions, no API keys.
---
