...
description: Franklin is the AI agent with a wallet. It writes code and spends USDC autonomously across 78 models and paid APIs, settling per outcome over x402. No API keys.
---
