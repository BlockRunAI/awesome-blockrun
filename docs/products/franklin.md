...
description: Franklin is the AI agent with a wallet — it writes code and spends USDC autonomously across 61 models and paid APIs, settling per outcome over x402. No subscriptions, no API keys.
---
...
- **Models & routing** — picks the best model per task via [ClawRouter](routing/clawrouter.md)'s scoring, across 61 chat models.
